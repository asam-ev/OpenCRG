...
m_opts.css = [
   ...
   '#asam-logo-container { height: 100%; width: 30%; background: url(https://www.asam.net/typo3conf/ext/asam_cms/Resources/Public/Images/asam-logo.svg) center no-repeat; }' ...
